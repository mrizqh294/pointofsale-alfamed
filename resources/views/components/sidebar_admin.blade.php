<aside class="flex flex-col items-stretch h-full w-64  bg-green-500 text-white">
    ...
    <nav class="font-semibold" x-data="{ isOpen: false, laporanIsOpen: false }" x-cloak>
      <div class="max-h-full flex flex-col content-between">
        <div>
          ...
          <a href="/admin/pengguna" class="block py-2.5 px-6 hover:bg-green-400"><i class="fa-solid fa-user p-2"></i>Pengguna</a>
    ...
    <div class="font-semibold">
      <a href="{{ route('logout') }}" class="block py-2.5 px-6 hover:bg-green-400"><i class="fa-solid fa-right-from-bracket p-2"></i>Keluar</a>
    </div>
</aside>