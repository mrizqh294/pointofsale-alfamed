        ...
        <div class="" x-data="{ isOpenAdd: false, isOpenDestroy: false, isOpenUpdate: false, id: null, current: {} }" x-cloak>
          ...
          @endif
              ...
              <div>
                <form action="{{ route('pembelian.getPurchase') }}" method="get" class="">
                  ...
                  <div class="flex items-center">
                    ...
                    <a href="{{ route('pembelian.getPurchase') }}" class="mx-1 cursor-pointer border border-teal-600 bg-gray-100 hover:bg-gray-200 text-teal-600 px-3 py-2 rounded-lg"><i class="fa-solid fa-arrows-rotate"></i></a>
                    <a href="{{ route('pembelian.exportPembelian', request()->query()) }}" class="mx-1 cursor-pointer bg-teal-600 hover:bg-teal-700 text-white px-3 py-2 rounded-lg"><i class="fa-solid fa-file-excel"></i> Ekspor</a>
                  </div>
                </form>
              </div>
            ...
            <div class="fixed top-0 left-0 w-full h-screen bg-black/40 flex justify-center items-center" x-show="isOpenDestroy">
              <div class="p-8 bg-white w-1/3 rounded-xl justify-center place-items-center">
                ...
                <p class="my-4 text-center">Lakukan tindakan ini hanya ketika diperlukan. Menghapus data pembelian dapat menyebakan perubahan data stok obat.</p>
