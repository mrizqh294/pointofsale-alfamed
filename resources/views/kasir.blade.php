    ...
    <x-main_content>
        ...
        <div class="flex flex-col w-full h-full items-center justify-center">
            ...
            <div class="my-8">
                ...
                <a href="/kasir/transaksi/riwayat" class="inline-block w-70 text-center cursor-pointer bg-teal-600 hover:bg-teal-700 text-white px-3 py-3 rounded-lg">Riwayat</a>
            </div>
        </div>
    </x-main_content>
</x-layout>
