                ...
                <form action="{{ route('pemilik.getPurchase') }}" method="get" class="">
                  @csrf
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('pemilik.getPurchase') }}" class="ms-1 cursor-pointer border border-teal-600 bg-gray-100 hover:bg-gray-200 text-teal-600 px-3 py-2 rounded-lg"><i class="fa-solid fa-arrows-rotate"></i></a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <table class="min-w-full table-fixed border ">
                ...
                <tbody class="">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <a href="{{ route('pemilik.getPurchaseDetail',$purchase->id_pembelian) }}"><button class="bg-blue-500 cursor-pointer hover:bg-blue-600 text-white px-3 py-1 rounded mr-2"><i class="fa-solid fa-circle-info my-1"></i></button></a>
